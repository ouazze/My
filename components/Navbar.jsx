    ...
    return (
        <>
            ...
            <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 
                ...
                <ul ref={sideMenuRef} className={`fixed top-0 bottom-0 right-0 w-64 z-50 h-screen bg-rose-50 shadow-lg transition-transform duration-500 transform 
                    ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'} dark:bg-darkHover dark:text-white flex flex-col items-start pl-8 pt-12`}>
